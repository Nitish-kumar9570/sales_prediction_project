...
st.sidebar.header("Ad Budget")
tv = st.sidebar.slider("TV Budget", 0, 300, 150)
radio = st.sidebar.slider("Radio Budget", 0, 50, 25)
newspaper = st.sidebar.slider("Newspaper Budget", 0, 120, 40)
...
<div class="hero">
  ...
  <p class="hero-sub">Units Expected | Budget: {tv+radio+newspaper} | R2: {r2:.2f}</p>
